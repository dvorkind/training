...
INSERT INTO `user` (`account_id`, `firstname`, `lastname`, `phone_number`, `balance`, `is_blocked`, `is_registered`)
VALUES ('2', 'Иван', 'Иванов', '+375000000000', 0, 1, 0),
       ('3', 'Петр', 'Петров', '+375000000001', 0, 1, 0),
       ('4', 'Борис', 'Борисов', '+375000000002', 0, 1, 0),
       ('5', 'Анна', 'Анина', '+375000000003', 0, 1, 0),
       ('6', 'Виктория', 'Викториева', '+375000000004', 0, 1, 0),
       ('7', 'Юлия', 'Юлиева', '+375000000005', 0, 1, 0),
       ('8', 'Наташа', 'Наталина', '+375000000006', 0, 1, 0),
       ('9', 'Сидор', 'Сидоров', '+375000000007', 0, 1, 0),
       ('10', 'Василий', 'Васильев', '+375000000008', 0, 1, 0),
       ('11', 'Марина', 'Маринина', '+375000000009', 0, 1, 0);
